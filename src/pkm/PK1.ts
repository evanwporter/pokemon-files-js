...
import { Languages, ItemToString } from 'pokemon-resources'
...
export class PK1 {
  ...
  constructor(arg: ArrayBuffer | AllPKMFields, encrypted?: boolean) {
    if (arg instanceof ArrayBuffer) {
      ...
      this.gameOfOrigin = 0
      this.gameOfOrigin = this.languageIndex = 0
      this.languageIndex = this.dexNum = conversion.fromGen1PokemonIndex(dataView.getUint8(0x0))
